<template>
<div className="card h-[496px]">
      <div className="flex items-center z-10 gap-8 h-full">
        <section className="h-full w-[320px] ">
          <div className="relative w-full h-full flex justify-center items-center">
            ...
            <img className="ml-1 mb-2 rounded-lg" width={320} src={Pattern} alt="patter" />
          </div>
        </section>
